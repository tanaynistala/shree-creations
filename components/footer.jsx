...
export default function Footer() {
  return (
    <footer className="bg-slate-50 bg-opacity-30 lg:grid lg:grid-cols-5">
      <aside className="hidden lg:relative lg:col-span-2 lg:block group">
        <a
          className="flex flex-col absolute inset-0 w-full text-center text-[16rem] transition bg-slate-50 bg-opacity-50"
          href="#"
        >
          <div className="">
            <Image
          ...
          <div className="opacity-0 z-30 group-hover:block transition m-auto group-hover:opacity-100">
            <svg
      ...
      {/* <a
          className="hidden group-hover:block absolute z-10 w-full text-center text-[16rem] bg-slate-50 bg-opacity-50"
          href="#"
        >
          &uarr;
        </a>
      ...
      <div className="px-4 py-16 sm:px-6 lg:px-8 lg:col-span-3">
        ...
        <div className="pt-12 mt-12 border-t border-gray-800">
          <div className="text-sm text-gray-500 sm:items-center sm:justify-between sm:flex">
            ...
            <p className="mt-4 sm:mt-0">&copy; 2022 Shree Creations.</p>
          </div>
